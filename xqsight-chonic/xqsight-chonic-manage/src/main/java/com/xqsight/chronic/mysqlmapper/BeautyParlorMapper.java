...
public interface BeautyParlorMapper {
	...
	@Select(" SELECT BEAUTY_ID,FILE_ID,BEAUTY_NAME,BEAUTY_ADDRESS,BEAUTY_PHONE,BEAUTY_QQ,BEAUTY_DESCRIPT,BEAUTY_LNG,BEAUTY_LAT,COMMENT_HAS_PIC,ACTIVE,CREATE_TIME,CREATE_OPR_ID,UPDATE_TIME,UPD_OPR_ID,REMARK FROM BEAUTY_PARLOR WHERE BEAUTY_NAME LIKE '%${beautyName}%' ORDER BY CREATE_TIME DESC")
	List<BeautyParlor> queryBeautyParlor(@Param("beautyName")String beautyName);
