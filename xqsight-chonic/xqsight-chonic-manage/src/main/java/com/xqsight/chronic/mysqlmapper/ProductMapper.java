...
public interface ProductMapper {
	...
	@Select("SELECT P.PRODUCT_ID,P.PRODUCT_NAME,P.PRODUCT_DESCRIPTION,P.PRODUCT_PRICE,ifnull(SF.FILE_URL,' ') IMG_PATH FROM PRODUCT P LEFT JOIN SYS_FILE SF ON SF.FILE_ID = SUBSTRING_INDEX(P.FILE_ID,',',1) ORDER BY P.CREATE_TIME DESC")
