...
/** 用户信息初始化 **/
insert into `sys_login` (`id`, `department_id`,`login_id`, `user_name`, `password`, `login_type`, `from_source`, `img_url`, `salt`, `locked`, `sex`, `age`, `active`, `create_time`, `create_user_id`, `update_time`, `update_user_id`, `remark`) values
