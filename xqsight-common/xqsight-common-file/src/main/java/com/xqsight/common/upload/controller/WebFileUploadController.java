 ...
 */
@Controller
@RequestMapping("/template/web_file_2")
public class WebFileUploadController extends WebFileControllerAbstractor {
    ...
    protected String getUrlPrefix() {
        return uploadSupport.getUrlPrefix();
    }
    ...
    @Override
    public String save(String parentId, String name, String text, String redirect, HttpServletRequest request, HttpServletResponse response, RedirectAttributes ra) throws IOException {
