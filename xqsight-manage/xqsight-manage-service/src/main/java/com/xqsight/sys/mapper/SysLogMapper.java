...
public interface SysLogMapper {
	...
	@Select(" SELECT log_id,log_type,log_title,log_desc,req_ip,req_url,req_method,req_data,exception,agent_user,create_opr_id,create_time,remark FROM sys_log WHERE log_id=#{logId,jdbcType=NUMERIC}")
	SysLog querySysLogById(@Param("logId") Long logId);

	@Select(" SELECT log_id,log_type,log_title,log_desc,req_ip,req_url,req_method,req_data,exception,agent_user,create_opr_id,create_time,remark FROM sys_log")
