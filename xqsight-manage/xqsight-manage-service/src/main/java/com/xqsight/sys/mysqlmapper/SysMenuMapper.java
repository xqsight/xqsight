...
public interface SysMenuMapper {
	...
	@Select("select menu_name , menu_id, parent_id from sys_menu where type=0 order by sort asc")
	...
	@Select("select menu_name , menu_id, parent_id from sys_menu order by sort asc")
