                ...
                for (i = 0; i < rows.length; i++) {
                    ...
                    if (row.data(this.settings.nodeIdAttr) != null) {
                        ...
                        if (node.parentId != null && node.parentId != "0") {
                            if(this.tree[node.parentId] != undefined)
...
jQuery.TreeTable = function (tree_id, heads, tNodes) {
    if ($("#" + tree_id).length > 0) {
        ...
        var loadBodyHtml = function(nodes){
            $.each(nodes,function(index,obj){
                body_html += "<tr data-tt-id='" + obj.id + "' "
                    + (obj.pId ? "data-tt-parent-id='" + obj.pId + "'" : "")
                    + "><td class = 'td_left'><span class='"
                    + (obj.isLeaf == "1" ? "parent" : "children") + "'>"
                    + obj.name + "</span></td>";
                body_html += "<td>" + obj.active + "</td>";
                body_html += "<td>" + obj.available + "</td>";
                body_html += "<td>" + obj.sort + "</td>";
                body_html += "<td>" + obj.type + "</td>";
                if(obj.children.length > 0){
                    loadBodyHtml(obj.children);
                }
            })
        }

        loadBodyHtml(newNodes);

        body_html += "</tbody>";
        $("#" + tree_id).append( body_html);
